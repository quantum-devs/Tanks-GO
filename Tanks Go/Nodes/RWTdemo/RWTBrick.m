...
- (instancetype)initWithShader:(BaseEffect *)shader {
  if ((self = [super initWithName:"Brick" shader:shader vertices:(Vertex *)Cube_brick_Vertices vertexCount:sizeof(Cube_brick_Vertices)/sizeof(Cube_brick_Vertices[0])])) {
